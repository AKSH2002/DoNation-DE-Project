...
// export default function BloodCampSignIn() {
//   const { SigninBloodCamp } = useSignInHook();
...
//     e.persist();
//     setBloodCamp({ ...BloodCamp, [e.target.name]: e.target.value });
//   };

//   const handleSubmit = (e) => {
//     e.preventDefault();
//     SigninBloodCamp(BloodCamp)
//   };
...
//                   <Grid item>
//                     <br />
//                     <Link href="/blood-camp-signup" variant="body2" color="#c6414c">
