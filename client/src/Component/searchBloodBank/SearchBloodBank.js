...
const columns = [
	...
	{ field: "Name", headerName: "Full name", sortable: false, width: 200, disableColumnMenu: true,
	  valueGetter: (params) =>
		`${params.row.firstName || ""} ${params.row.lastName || ""}`
	},
	{ field: "address", headerName: "Address", sortable: false, disableColumnMenu: true, width: 180 },
	{ field: "phone", headerName: "Phone", sortable: false, disableColumnMenu: true, width: 100 },
	{ field: "email", headerName: "Email", sortable: false, disableColumnMenu: true, width: 70},
	{ field: "category", headerName: "Category", sortable: false, disableColumnMenu: true, flex: 1, minwidth: 300 },
	{ field: "type", headerName: "Type", sortable: false, disableColumnMenu: true, width: 70}
];
...
export default function SearchBloodBank() {
	...
	return (
		...
		<div className="search_donor_container" style={{backgroundImage: `url(${process.env.PUBLIC_URL + '/assets/search-bg.svg'})`}}>
			<section>
				<h1><span>Search</span> for <span>Blood Bank</span></h1>
			</section>
			<section>
